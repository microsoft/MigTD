...
/// When JSON `servtdCollateral` is present, its signed mapping, optional
/// identity, and both issuer chains are redacted; a CoRIM-only policy has no
/// `servtdCollateral` and is measured in full. See
