...
* [MigTD Architecture Overview (Azure Build)](knowledge/architecture-overview.md) - Layered/component diagrams, kernel-free boot, dispatcher/migration/SPDM/rebind sequences, an alternate RA-TLS view, policy-v2 trust, and IGVM image build.
* [Azure WaitForRequest Error and ReportStatus Map](knowledge/azure-waitforrequest-errors.md) - Azure IGVM vmcall-raw/SPDM error logging and ReportStatus behavior.
